<?php 
    ...
    if (isset($_GET['export']) && $_GET['export'] === 'csv') {
        ...
        header('Content-Disposition: attachment; filename=accepted_by_region_' . date('Y-m-d') . '.csv');
        
        $output = fopen('php://output', 'w');
        fwrite($output, "\xEF\xBB\xBF");
        
        // CSV Headers
        fputcsv($output, ['Region', 'Total Deliveries', 'Accepted', 'Pending', 'Delivered', 'Acceptance Rate (%)']);
...
<div class="d-flex justify-content-between align-items-center mb-3">
    <h4>✅ Accepted by Region Report <?= $selectedProject > 0 ? "- " . htmlspecialchars($selectedProjectName) : "" ?></h4>
...
<table id="acceptedRegionTable" class="table table-bordered shadow-sm">
