...
document.addEventListener("DOMContentLoaded", function () {
  ...
  if (inventoryByWarehouse && inventoryByWarehouse.length > 0) {
    ...
    const container = document.getElementById("warehouseChartsContainer");
    container.innerHTML =
      '<div class="col-12 text-center text-muted py-5"><p>No inventory data available</p></div>';
  }
            ...
            callbacks: {
              label: function (context) {
                ...
                if (context.dataset.label === "Accepted") {
                  ...
                  return `Not Accepted: ${
                    regionData.total - regionData.accepted
                  }/${regionData.total} (${context.parsed.y}%)`;
                }
              },
            },
          },
              ...
              label: function (context) {
                ...
                if (context.dataset.label === "Delivered") {
                  ...
                  return `Not Delivered: ${
                    regionData.total - regionData.delivered
                  }/${regionData.total} (${context.parsed.y}%)`;
                }
              },
            },
            ...
            callbacks: {
              label: function (context) {
                ...
                if (context.dataset.label === "Accepted") {
                  ...
                  return `Not Accepted: ${lotData.total - lotData.accepted}/${
                    lotData.total
                  } (${context.parsed.y}%)`;
                }
              },
            ...
            callbacks: {
              label: function (context) {
                ...
                if (context.dataset.label === "Delivered") {
                  ...
                  return `Not Delivered: ${lotData.total - lotData.delivered}/${
                    lotData.total
                  } (${context.parsed.y}%)`;
                }
              },
