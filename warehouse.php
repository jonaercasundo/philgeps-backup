<?php 
    ...
    $allowed_roles = ['Super Admin', 'Admin', 'Office Coordinator', 'Office Admin', 'Warehouse Coordinator', 'Warehouse Admin'];
    ...
    <div class="col-md-3 border-end d-flex flex-column">
        ...
        <div class="flex-fill p-3 border-top d-flex flex-column">
            <div class="chart-container h-100">
                <canvas id="warehouseStockLevelsChart" class="h-100"></canvas>
            </div>
        </div>
...
<script>
    ...
    fetch('script/get_warehouse_summary.php')
        ...
        .catch(error => {
            console.error('Error fetching warehouse delivery data:', error);
            document.getElementById('warehouseStockLevelsChart').parentElement.innerHTML = 
